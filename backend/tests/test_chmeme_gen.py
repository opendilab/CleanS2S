...
def get_smaples_random(data,sample_num=None):
    data_dict=data
...
def get_ans_chmeme_ch(data_dict,image_list,client,end_point,cared_keys,sys_prompt):
    ch_dataset={}
    error_imgs=[]
    token_usage=0
...
def get_dataset(data,prompt_path,client_endpoint,prefix,select_numbers=None):
...
def main():
    ...
    processed_numbers=[
    272, 4123, 3686, 497, 4997, 5405, 5695, 1879, 262, 1747,
    1998, 1869, 2477, 654, 1261, 5335, 3862, 3498, 5629, 2968,
    1873, 1185, 5677, 1765, 1217, 5253, 3787, 2489, 5645, 5567,
    3715, 2209, 2622, 81, 1401, 1489, 835, 1515, 1328, 2862,
    367, 3306, 671, 1095, 4732, 3097, 459, 5485, 6014, 427,
    853, 82, 1410, 5705, 305, 4033, 989, 522, 462, 5452,
    4147, 1098, 3999, 3240, 705, 1058, 1110, 1812, 4249, 4128,
    2720, 735, 2972, 1864, 2370, 5380, 4488, 4730, 908, 3923,
    4884, 5014, 3096, 2463, 3015, 4947, 931, 4984, 5200, 3626,
    6012, 3315, 628, 3734, 708, 2805, 5022, 5552, 5765, 1072
    ]
